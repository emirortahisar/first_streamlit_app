...
my_fruit_add=streamlit.dataframe(my_data_row)

my_fruit_add=streamlit.text_input('what fruit you like information about ?','Kiwi')
streamlit.write('the user entered' , my_fruit_add)
